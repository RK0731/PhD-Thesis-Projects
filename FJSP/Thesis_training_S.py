...
class shopfloor:
    def __init__(self, env, span, m_no, wc_no, **kwargs):
        ...
        self.brain = brain_machine_S.sequencing_brain(self.env, self.job_creator, self.m_list, self.m_list, self.span/10, self.span, \
        MC = 0, IQL = 0, I_DDQN = 0, MR = 1, \
        reward_function = 13)
