...
class shopfloor:
    def __init__(self, env, span, m_no, wc_no, **kwargs):
        ...
        self.routing_brain = brain_workcenter_R.routing_brain(self.env, self.job_creator, self.m_list, self.wc_list, self.span/10, self.span,\
        IQL = 0, I_DDQN = 0,\
        global_reward = 0)
